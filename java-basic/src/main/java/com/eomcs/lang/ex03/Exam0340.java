...
public class Exam0340 {
  ...
  static double test1 = 12.375d;

  public static void main(String[] args) {

    //유효자리수 범위의 부동소수점을 2진수로 변환하면 최소의 오차로 값을 저장.
    //## 4byte(float) 부동소수점의 유효자릿수 4*8 = 32bit / 7~8자리
    ...
    //## 8byte(double) 부동소수점의 유효자릿수 8*8 = 64bit : 16자리
    ...
    System.out.println(0.0000000000987654);
    System.out.println("----------------------------");
